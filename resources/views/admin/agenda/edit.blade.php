            ...
            <form action="{{ route('admin.agenda.update', $agenda->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" rows="4"
                              class="form-control summernote @error('description') is-invalid @enderror">{{ old('description', $agenda->description) }}</textarea>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="datetime-local" name="start_date"
                               ...
                               value="{{ old('start_date', \Carbon\Carbon::parse($agenda->start_date)->format('Y-m-d\TH:i')) }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="datetime-local" name="end_date"
                               ...
                               value="{{ old('end_date', \Carbon\Carbon::parse($agenda->end_date)->format('Y-m-d\TH:i')) }}" required>
